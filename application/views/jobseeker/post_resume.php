...
=======
<div class="container">
  <form class="form-horizontal post-resume">
    <div class="row-fluid">
      <div class="span6">
        <div class="control-group">
          <label class="control-label" for="title">Title</label>
          <div class="controls">
            <input type="text" id="title" placeholder="Resume Title" class="span10">
          </div>
        </div>
        <div class="control-group">
      ...
      <div class="span6">
        ...
        <div class="control-group">
          <label class="control-label" for="province">Upload Resume</label>
          <div class="controls">
            <input class="" type="file">
          </div>
        </div>
        <div class="control-group">
          <label class="control-label" for="province">Add Photo</label>
          <div class="controls">
            <input class="" type="file">
